...
//    Logger.getLogger("org").setLevel(Level.ERROR)
    ...
    // 3. 调用测试主程序
    CreateMroTable.executeCreateMroTable(Array(".\\conf\\mro-ftpdata-to-hive-conf.properties"),hadoopConfMap)
    //FTPCompressedFileToHive.executeFTPCompressedFileToHive(null,hadoopConfMap)
